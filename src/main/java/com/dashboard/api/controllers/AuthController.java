...
import com.dashboard.api.payload.response.MessageResponse;
            ...
            strRoles.forEach(role -> {
                switch (role) {
                    ...
                    case "mod":
                        ...
                        break;
                    case "autoApprove":
                        Role autoApproveRole = roleRepository.findByName(ERole.ROLE_AUTO_APPROVE)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(autoApproveRole);
                    ...
                    case "request":
                        ...
                        break;
                    case "ownRequest":
                        Role ownRequestRole = roleRepository.findByName(ERole.ROLE_MANAGE_OWN_REQUEST)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(ownRequestRole);

                        break;
                    case "disable":
                        Role disableRole = roleRepository.findByName(ERole.ROLE_DISABLE)
                                .orElseThrow(() -> new RuntimeException("Error: Role is not found."));
                        roles.add(disableRole);
